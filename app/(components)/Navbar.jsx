  ...
  return (<>
    ...
    flex justify-between items-center px-4'>
        <div className="logo__container">
            <Link href="/"><img src='/brand.png' className='object-contain' width={200} height={200} alt="Haarmonie By Oz" /></Link>
        </div>
        <div className="navItems__container max-[600px]:hidden ">
            <ul className='flex gap-4 '>
                ...
                <Link href="impressum"><li className='hover:underline hover:underline-offset-8'>Impressum</li></Link>
            </ul>            
        </div>
    ...
    {isMobile ?     <div className="mobileSide__container bg-[#231f20] absolute right-0 left-0 z-10 -translate-y-[1000px] duration-1000 ease-in-out">
             <ul className='flex flex-col text-3xl items-center gap-10 mt-40 '>
                ...
                <Link href="impressum"><li>Impressum</li></Link>
             </ul>  
             ...
             <ul className='flex flex-col text-2xl items-center gap-14 mt-40 '>
                ...
                <Link href="impressum"><li onClick={handleMobile}>Impressum</li></Link>
             </ul>  
             <div className='social_media_container max-[750px]:pb-6 max-[750px]:pt-10'>
